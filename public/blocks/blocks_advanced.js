...
{
  "type": "print",
  "message0": "%{BKY_YY_MENU_ADVANCED_PRINT}",
  "args0": [
    {
      "type": "input_value",
      "name": "value"
...
{
  "type": "light_sleep",
  "message0": "%{BKY_YY_MENU_ADVANCED_POWER_LIGHT_SLEEP}",
  "args0": [
    {
      "type": "input_value",
      "name": "time",
...
{
  "type": "deep_sleep",
  "message0": "%{BKY_YY_MENU_ADVANCED_POWER_DEEP_SLEEP}",
  "args0": [
    {
      "type": "input_value",
      "name": "time",
...
{
  "type": "board_reset",
  "message0": "%{BKY_YY_MENU_ADVANCED_POWER_BOARD_RESET}",
  "inputsInline": true,
  "previousStatement": null,
  "nextStatement": null,
  "colour": "#8E44AD",
