    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-6xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">Windtree Signature<br/></span>
        </span>{' '}
        Robotics Programming
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Coding and Robotics Education for K-12 students  
      </p>
              ...
              >
                {group.map((company) => (
                  <li key={company.name} className="flex">
                    <Image src={company.logo} alt={company.name} unoptimized layout="fixed"/>
                  </li>
                ))}
              </ul>
            </li>
