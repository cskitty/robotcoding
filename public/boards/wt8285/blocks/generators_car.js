Blockly.Python['yy_car_forward'] = function(block) {
  Blockly.Python.definitions_['import_wt_8285_car'] = 'from wtcar8285 import WTCar8285';
  Blockly.Python.definitions_['def_wt_8285_car'] = 'car = WTCar8285()';
...
Blockly.Python['yy_car_backward'] = function(block) {
  ...
  var code = `car.Backward(time_dur=${value_time})\n`;
  return code;
};
